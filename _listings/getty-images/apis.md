...
- name: Getty Images Delete a comment from a board
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/boards/master/_listings/getty-images/v3-boards-board-id-comments-comment-id-delete-postman.md
x-common:
