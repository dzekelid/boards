...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/boards/master/_listings/server-density/apis.md
...
- name: Dashboards API Deleting a dashboard
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/boards/master/_listings/server-density/usersdashboardsdashboardid--openapi.md
- name: Dashboards API Duplicating a dashboard
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/boards/master/_listings/server-density/usersdashboardsduplicatedasboardid--openapi.md
- name: Dashboards API
  x-api-slug: dashboards-api
  description: SaaS infrastructure monitoring. Dashboards, graphs and alerts to help
    you improve performance and maintain uptime. Organizer of @humanops
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/boards/master/_listings/server-density/openapi.md
x-common:
- type: x-website
